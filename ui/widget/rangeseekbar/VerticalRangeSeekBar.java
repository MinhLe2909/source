...
import tamhoang.ldpro4.ui.widget.rangeseekbar.VerticalSeekBar;
...
public class VerticalRangeSeekBar extends RangeSeekBar {
    ...
    protected void initSeekBar(AttributeSet attrs) {
        leftSB = new tamhoang.ldpro4.ui.widget.rangeseekbar.VerticalSeekBar(this, attrs, true);
        rightSB = new tamhoang.ldpro4.ui.widget.rangeseekbar.VerticalSeekBar(this, attrs, false);
        ...
        if (getTickMarkTextArray() != null) {
            ...
            for (int i = 0; i < arrayLength; i++) {
                ...
                if (getTickMarkMode() == TRICK_MARK_MODE_OTHER) {
                    ...
                    if (tamhoang.ldpro4.ui.widget.rangeseekbar.Utils.compareFloat(num, states[0].value) != -1 && tamhoang.ldpro4.ui.widget.rangeseekbar.Utils.compareFloat(num, states[1].value) != 1 && (getSeekBarMode() == SEEKBAR_MODE_RANGE)) {
    ...
    protected int getTickMarkRawHeight() {
        ...
        if (getTickMarkTextArray() != null && getTickMarkTextArray().length > 0) {
            int arrayLength = getTickMarkTextArray().length;
            maxTickMarkWidth = tamhoang.ldpro4.ui.widget.rangeseekbar.Utils.measureText(String.valueOf(getTickMarkTextArray()[0]), getTickMarkTextSize()).width();
     ...
     */
    public tamhoang.ldpro4.ui.widget.rangeseekbar.VerticalSeekBar getLeftSeekBar() {
        return (tamhoang.ldpro4.ui.widget.rangeseekbar.VerticalSeekBar) leftSB;
    }

    public tamhoang.ldpro4.ui.widget.rangeseekbar.VerticalSeekBar getRightSeekBar() {
