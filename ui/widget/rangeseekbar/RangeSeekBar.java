...
import tamhoang.ldpro4.ui.widget.rangeseekbar.SavedState;
import tamhoang.ldpro4.ui.widget.rangeseekbar.SeekBar;
import tamhoang.ldpro4.ui.widget.rangeseekbar.SeekBarState;
import tamhoang.ldpro4.ui.widget.rangeseekbar.Utils;
...
public class RangeSeekBar extends View {
    ...
    tamhoang.ldpro4.ui.widget.rangeseekbar.SeekBar leftSB;
    tamhoang.ldpro4.ui.widget.rangeseekbar.SeekBar rightSB;
    tamhoang.ldpro4.ui.widget.rangeseekbar.SeekBar currTouchSB;
    ...
    private void initProgressBitmap() {
        if (progressBitmap == null) {
            progressBitmap = tamhoang.ldpro4.ui.widget.rangeseekbar.Utils.drawableToBitmap(getContext(), progressWidth, progressHeight, progressDrawableId);
        }
        if (progressDefaultBitmap == null) {
            progressDefaultBitmap = tamhoang.ldpro4.ui.widget.rangeseekbar.Utils.drawableToBitmap(getContext(), progressWidth, progressHeight, progressDefaultDrawableId);
        }
    }
    ...
    private void initStepsBitmap() {
        ...
        if (stepsBitmaps.isEmpty()) {
            Bitmap bitmap = tamhoang.ldpro4.ui.widget.rangeseekbar.Utils.drawableToBitmap(getContext(), (int) stepsWidth, (int) stepsHeight, stepsDrawableId);
    ...
    private void initSeekBar(AttributeSet attrs) {
        leftSB = new tamhoang.ldpro4.ui.widget.rangeseekbar.SeekBar(this, attrs, true);
        rightSB = new tamhoang.ldpro4.ui.widget.rangeseekbar.SeekBar(this, attrs, false);
    ...
    private void initAttrs(AttributeSet attrs) {
        try {
            ...
            progressHeight = (int) t.getDimension(R.styleable.RangeSeekBar_rsb_progress_height, tamhoang.ldpro4.ui.widget.rangeseekbar.Utils.dp2px(getContext(), 2));
            ...
            tickMarkTextMargin = (int) t.getDimension(R.styleable.RangeSeekBar_rsb_tick_mark_text_margin, tamhoang.ldpro4.ui.widget.rangeseekbar.Utils.dp2px(getContext(), 7));
            tickMarkTextSize = (int) t.getDimension(R.styleable.RangeSeekBar_rsb_tick_mark_text_size, tamhoang.ldpro4.ui.widget.rangeseekbar.Utils.dp2px(getContext(), 12));
    ...
    protected void onMeasureProgress(int w, int h) {
        ...
        if (gravity == Gravity.TOP) {
            ...
            if (leftSB.getIndicatorShowMode() != tamhoang.ldpro4.ui.widget.rangeseekbar.SeekBar.INDICATOR_ALWAYS_HIDE
                    || rightSB.getIndicatorShowMode() != tamhoang.ldpro4.ui.widget.rangeseekbar.SeekBar.INDICATOR_ALWAYS_HIDE) {
    ...
    protected int getTickMarkRawHeight() {
        if (tickMarkTextArray != null && tickMarkTextArray.length > 0) {
            return tickMarkTextMargin + tamhoang.ldpro4.ui.widget.rangeseekbar.Utils.measureText(String.valueOf(tickMarkTextArray[0]), tickMarkTextSize).height() + 3;
        }
        return 0;
    }
        ...
        if (tickMarkTextArray != null) {
            ...
            for (int i = 0; i < tickMarkTextArray.length; i++) {
                ...
                if (tickMarkMode == TRICK_MARK_MODE_OTHER) {
                    ...
                    float num = tamhoang.ldpro4.ui.widget.rangeseekbar.Utils.parseFloat(text2Draw);
                    SeekBarState[] states = getRangeSeekBarState();
                    if (tamhoang.ldpro4.ui.widget.rangeseekbar.Utils.compareFloat(num, states[0].value) != -1 && tamhoang.ldpro4.ui.widget.rangeseekbar.Utils.compareFloat(num, states[1].value) != 1 && (seekBarMode == SEEKBAR_MODE_RANGE)) {
    ...
    protected void onDrawProgressBar(Canvas canvas, Paint paint) {
        ...
        if (tamhoang.ldpro4.ui.widget.rangeseekbar.Utils.verifyBitmap(progressDefaultBitmap)) {
        ...
        if (tamhoang.ldpro4.ui.widget.rangeseekbar.Utils.verifyBitmap(progressBitmap)) {
    ...
    protected void onDrawSeekBar(Canvas canvas) {
        //draw left SeekBar
        if (leftSB.getIndicatorShowMode() == tamhoang.ldpro4.ui.widget.rangeseekbar.SeekBar.INDICATOR_ALWAYS_SHOW) {
            leftSB.setShowIndicatorEnable(true);
        }
        leftSB.draw(canvas);
        //draw right SeekBar
        if (seekBarMode == SEEKBAR_MODE_RANGE) {
            if (rightSB.getIndicatorShowMode() == tamhoang.ldpro4.ui.widget.rangeseekbar.SeekBar.INDICATOR_ALWAYS_SHOW) {
    ...
    public Parcelable onSaveInstanceState() {
        ...
        tamhoang.ldpro4.ui.widget.rangeseekbar.SavedState ss = new tamhoang.ldpro4.ui.widget.rangeseekbar.SavedState(superState);
    ...
    public void onRestoreInstanceState(Parcelable state) {
        try {
            tamhoang.ldpro4.ui.widget.rangeseekbar.SavedState ss = (SavedState) state;
    ...
    public SeekBarState[] getRangeSeekBarState() {
        ...
        if (tamhoang.ldpro4.ui.widget.rangeseekbar.Utils.compareFloat(leftSeekBarState.value, minProgress) == 0) {
            leftSeekBarState.isMin = true;
        } else if (tamhoang.ldpro4.ui.widget.rangeseekbar.Utils.compareFloat(leftSeekBarState.value, maxProgress) == 0) {
        ...
        if (seekBarMode == SEEKBAR_MODE_RANGE) {
            ...
            if (tamhoang.ldpro4.ui.widget.rangeseekbar.Utils.compareFloat(rightSB.currPercent, minProgress) == 0) {
                rightSeekBarState.isMin = true;
            } else if (tamhoang.ldpro4.ui.widget.rangeseekbar.Utils.compareFloat(rightSB.currPercent, maxProgress) == 0) {
     ...
     */
    public tamhoang.ldpro4.ui.widget.rangeseekbar.SeekBar getLeftSeekBar() {
        return leftSB;
    }
