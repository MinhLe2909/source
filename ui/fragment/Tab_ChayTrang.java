...
public class Tab_ChayTrang extends Fragment implements TabHost.OnTabChangeListener, ViewPager.OnPageChangeListener {
    private Frag_ChayTrang_Acc chayTrangAccFragment;
    private Frag_ChaytrangNew chayTrangFragment;
    int i = 0;
    ...
    private void initializeViewPager() {
        ...
        Frag_ChaytrangNew frag_ChaytrangNew = new Frag_ChaytrangNew();
        this.chayTrangFragment = frag_ChaytrangNew;
        vector.add(frag_ChaytrangNew);
        Frag_ChayTrang_Acc frag_ChayTrang_Acc = new Frag_ChayTrang_Acc();
        this.chayTrangAccFragment = frag_ChayTrang_Acc;
        vector.add(frag_ChayTrang_Acc);
    ...
    public void onTabChanged(String s) {
        ...
        if (!currentTabTag.contains("Chạy Trang") || (frag_ChaytrangNew = this.chayTrangFragment) == null) {
            return;
        }
        frag_ChaytrangNew.refresh();
    }
}
