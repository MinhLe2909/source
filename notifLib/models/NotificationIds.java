...
public class NotificationIds {
    ...
    /* JADX WARN: Type inference failed for: r1v2, types: [tamhoang.ldpro4.notifLib.models.NotificationIds$1] */
    public NotificationIds(final Context context) {
        ...
        new AsyncTask() { // from class: tamhoang.ldpro4.notifLib.models.NotificationIds.1
